...
/*This extension function uses suspendCoroutine to convert a callback based API to a suspend function.
Coroutines can call await and will immediately suspend until the network result is ready.
The network result is the return value of await, and errors will throw an exception.*/
